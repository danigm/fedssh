...
# Script for delete a public key to the authorized_keys file of a
...
if [ -a "/home/$1/.ssh/authorized_keys" ]; then
        ...
        if [ "$DoesExist" -ne 0 ]; then
                echo Key already exists in authorized_keys file, deleting...
                grep -v "$2" /home/$1/.ssh/authorized_keys > /home/$1/.ssh/authorized_keys2
                mv /home/$1/.ssh/authorized_keys2 /home/$1/.ssh/authorized_keys 
                exit 1
        fi
fi
